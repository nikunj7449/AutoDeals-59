...
public class AppointmentRequest {
    ...
    public AppointmentRequest(String brand, String rtoLocation, String year, String model, String variant, String owner, String kmDriven, String userType, String status, Long userId, Long carId, String date, String time) {
        this.brand = brand;
