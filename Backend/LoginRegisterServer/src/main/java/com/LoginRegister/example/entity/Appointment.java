...
public class Appointment {
    ...
    public Appointment(String brand, String rtoLocation, String year, String model, String variant, String owner, String kmDriven, String userType, String status, Long userId, Long carId) {
        this.brand = brand;
